...
[LinuxGSM](https://linuxgsm.com) 是用于快速，简单地部署和管理Linux专用游戏服务器的命令行工具。

## 无忧专用游戏服务器

传统的游戏服务器不容易自己管理。管理员经常要花上几个小时来捣乱，试图让他们的服务器正常工作。LinuxGSM是一个命令行工具，设计得尽可能简单，允许管理员在管理上花费更少的时间，在游戏上花费更多的时间。
...
只要满足最低要求，LinuxGSM就可以在流行的发行版上运行。

* Ubuntu
* Debian
* CentOS

其他发行版也可能有效，但尚未经过全面测试。

## :wrench: 要求

每个游戏服务器都有其特定的依赖性要求。访问[LinuxGSM](https://linuxgsm.com) 网站上的特定游戏服务器安装页面，检查要安装的游戏服务器的依赖性要求。

## :blue_book: 文献资料

文档位于[linuxgsm.com](https://linuxgsm.com)网站以及[docs.linuxgsm.com](https://docs.linuxgsm.com)网站。

## :question: 支持

获得支持的方法有很多种，请查看[支持](https://linuxgsm.com/support/) 页面以获得正确的支持。

## :heart: 捐赠

如果你想为这个项目[捐款](https://linuxgsm.com/donate) ，有几种方法可以通过 [GitHub赞助商](https://github.com/sponsors/dgibbs64)  和 [PayPal](https://www.paypal.me/dgibbs64) 。我要感谢每一位曾经捐款的人。自2012年以来，LinuxGSM一直在稳步增长，并定期添加新的服务器、功能和改进。

## 贡献者

非常感谢所有为该项目贡献想法，代码，文档和支持的优秀人员。
